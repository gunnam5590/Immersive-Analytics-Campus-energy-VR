...
This project visualizes Bangor University 2020 energy dataset in a 3D VR environment. Each building is represented as a 3D bar whose height corresponds to an energy metric. 
...
chartRoot --> Contains all 3D bars
labelsRoot --> Contains building labels
axesRoot --> Contains axis lines and values
viewerRoot --> Floating building info panel
metricButtonsRoot --> Metric selection buttons
